...
Core entities: `user`, `post`, `comment`, `familyTree`, `familyMember`, with authentication tables. All features are free with unlimited access.
...
- File uploads go directly to Cloudinary (no server-side processing)
