...
function RouteComponent() {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Finally, a genealogy tool that feels modern and intuitive. Collaborating with my cousins across the country has never been easier.",
    ...
    {
      quote:
        "The ability to attach photos and voices to our ancestors makes the history feel so alive. Highly recommended for every family.",
      author: "James Wilson",
      role: "Memory Keeper",
      initials: "JW",
    },
        ...
        <main className="relative z-20 flex-1 flex flex-col justify-center">
          <div className="space-y-8 text-center max-w-md mx-auto">
            ...
            <p className="text-muted-foreground text-lg font-serif italic">
              Continue preserving your family's unique journey and legacy.
            </p>
            ...
            <div className="pt-12 relative h-48">
              {testimonials.map((t, i) => (
                <div
                  key={i}
                  className={`absolute inset-0 transition-all duration-1000 flex flex-col items-center justify-center space-y-4 ${
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[400px]">
          <div className="flex flex-col space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground font-sans">
              Access your family tree and legacies
            </p>
          </div>
