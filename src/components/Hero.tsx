      ...
      <div className="container mx-auto px-4 relative z-[2] flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 max-w-5xl mx-auto">
          <div className="space-y-6">
            <FadeIn delay={100}>
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-extrabold tracking-tight text-foreground mb-6 leading-[1.1]">
                Visualize Your Legacy: <br />
                Build Your{" "}
            ...
            <FadeIn delay={200}>
              <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-muted-foreground mb-10 font-sans font-light leading-relaxed italic font-serif">
                Explore your family history through an intuitive node-based
                interface. Add members, share stories, and preserve your
                heritage for generations in our supportive community.
              </p>
            </FadeIn>
          </div>
